...
5.  **For the `experimental_methods` array**: List each distinct analytical method used (e.g., for measuring metal concentrations, soil properties, etc.). Provide the standard name for the method and include any details mentioned about the specific equipment (model, manufacturer).
...
```json
{
  ...
  "experimental_methods": [
    {
      "method_name": "String (e.g., Atomic Absorption Spectrometry, ICP-MS, pH measurement)",
      "purpose": "String (e.g., Determination of heavy metal concentrations in plant tissues, Soil pH analysis)",
      "equipment_details": "String (e.g., Atomic Absorption Spectrometer (AAS, model AA-7000, Shimadzu), pH meter (model XYZ, Mettler Toledo))"
    }
  ],
  "growth_medium": {
